...
import {Strings} from "../src/Strings_V01.sol";

contract LibStringTest is DSTestPlus {
    function testToString() public {
        assertEq(Strings.toString(uint256(0)), "0");
        assertEq(Strings.toString(uint256(1)), "1");
        assertEq(Strings.toString(uint256(17)), "17");
        assertEq(Strings.toString(uint256(99999999)), "99999999");
        assertEq(Strings.toString(uint256(99999999999)), "99999999999");
        assertEq(Strings.toString(uint256(2342343923423)), "2342343923423");
        assertEq(Strings.toString(uint256(98765685434567)), "98765685434567");
    }
    ...
    {
        string memory libString = Strings.toString(value);
    ...
    function testToStringOverwrite() public {
        string memory str = Strings.toString(uint256(1));
